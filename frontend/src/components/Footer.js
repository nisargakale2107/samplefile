        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
              <Link to="/Profile">
                <h2 className="mb-6 text-sm font-semibold uppercase">Profile</h2>
                </Link>
                <ul className="font-medium">
                  <li className="mb-4">
                    <Link to="https://github.com/NaikVedhas/43_EtherealElites_BnB24" className="hover:underline ">Github</Link>
                  </li>
                  <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <Link to="#" className="text-gray-200 hover:text-white ms-5">
